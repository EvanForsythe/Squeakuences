...
def runParser():
  ...
  parser.add_argument('-o', '--output', default=None, required=False, metavar='dir_path',
  ...
  parser.add_argument('-r', '--retain', action='store', default = None, required=False, metavar='tag',
    ...
    The information in this tag will not be cleaned and appended to the end of the cleaned sequence id without the tag and equals sign. Pass in the tag name in the format of -r 'locus='. 
...
def setDefaults(argsDict):
  ...
  if argsDict['stepbystep'] is False:
    argsDict.update({'stepbystep': False})
