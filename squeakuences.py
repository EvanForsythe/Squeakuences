...
def setupParser():
    ...
    parser.add_argument('-f', '--fileName', help='When activated, Squeakuences will add the file name to the beginning of all sequences cleaned.', required=False, action='store_true')
    return parser
