...
def main():
  ...
  if logFlag is True:
    checkExistingBenchmarkFile(logPath)
...
def setupParser():
  ...
  parser.add_argument('-b', '--log', help='When activated, Squeakuences will generate a log file with processing info from each fasta file cleaned.', required=False, action='store_true')
...
def checkExistingBenchmarkFile(logPath):
